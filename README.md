...
With the `enhancedSkip` option on the homebridge-appletv-enhanced plugin, and when watching YouTube, you can use the wording `Alexa, tv skip` to press skip after commercials.
