...
var Homebridges = require('../src/lib/parse/Homebridges.js').Homebridges;
// var alexaTranslator = require('../lib/alexaTranslator.js');
...
var checkEventDeviceList = require('../src/lib/parse/messages').checkEventDeviceList;
...
var endPoints = normalizeUUID(JSON.parse(response.replace(/\uFFFD/g, '')));
