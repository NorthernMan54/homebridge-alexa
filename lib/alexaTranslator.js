...
function _parseHAPtoAlexa(host, port, hapname, hap, filter) {
  ...
  for (var accessory in hap.accessories) {
    ...
    let aid = hap.accessories[accessory].aid;
        ...
        for (var id in device.services[service].characteristics) {
          ...
          if (type.startsWith("00000032")) {
            ...
            cookie["TurnOn"] = "{ \"host\": \"" + host + "\", \"port\": " + port + ", \"aid\": " +
              parseInt(aid) + ", \"iid\": " + parseInt(iid) + ", \"value\": 0 }"; // Open
            cookie["TurnOff"] = "{ \"host\": \"" + host + "\", \"port\": " + port + ", \"aid\": " +
              parseInt(aid) + ", \"iid\": " + parseInt(iid) + ", \"value\": 1 }"; // Closed
          ...
          // Active on a Fan 2 aka Dyson
          if (type.startsWith("000000B0") && serviceType.startsWith("000000B7")) {
          ...
          if (type.startsWith("000000CE")) {
            ...
            cookie["IncreaseColorTemperature"] = "{ \"host\": \"" + host + "\", \"port\": " + port + ", \"aid\": " +
              parseInt(aid) + ", \"iid\": " + parseInt(iid) + " }";
            cookie["DecreaseColorTemperature"] = "{ \"host\": \"" + host + "\", \"port\": " + port + ", \"aid\": " +
              parseInt(aid) + ", \"iid\": " + parseInt(iid) + " }";
            cookie["SetColorTemperature"] = "{ \"host\": \"" + host + "\", \"port\": " + port + ", \"aid\": " +
              parseInt(aid) + ", \"iid\": " + parseInt(iid) + " }";
