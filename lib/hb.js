...
exports.control = function(body, callback) {
    ...
    request({
        ...
        if (err || response.statusCode != 207) {
            console.error("Homebridge Control failed", err);
            ...
            try {
                ...
                //                console.error(ex);
                console.error("Homebridge Response Failed", response.statusCode, response.statusMessage);
                console.error("Homebridge Response Failed", response.body);
