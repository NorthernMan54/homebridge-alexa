...
exports.control = function(aid, iid, value, callback) {
            ...
            if (serviceType.startsWith("00000043") || serviceType.startsWith("00000047") ||
                ...
                for (var id in device.services[service].characteristics) {
                    ...
                    if (type.startsWith("00000025")) {
                        ...
                        additionalApplianceDetails["turnOn"] = "{ \"aid\": " + parseInt(aid) + ",\"iid\": " + parseInt(iid) + ",\"value\": 1 }";
                        additionalApplianceDetails["turnOff"] = "{ \"aid\": " + parseInt(aid) + ",\"iid\": " + parseInt(iid) + ",\"value\": 1 }";
                    ...
                    if (type.startsWith("00000008")) {
                        ...
                        additionalApplianceDetails["SetPercentageRequest"] = "{ \"aid\": " + parseInt(aid) + ",\"iid\": " + parseInt(iid) + ",\"value\": 1 }";

                        actions.push("SetPercentageRequest");
