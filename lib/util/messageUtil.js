// Used with V1 parser, will be deleted in the future
...
module.exports = {
  atvNameTranslate: atvNameTranslate,  // alexaTranslator
  ...
  StateToProperties: StateToProperties, // Copied
...
function lookupCapabilities(capability, options) {
  var response;
  switch (capability) {
