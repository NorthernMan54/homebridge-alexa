...
function endpointID(instance, manufacturer, name) {
  var response = new Buffer(instance.instance.txt.id + "-" + instance.instance.txt.md + "-" + manufacturer + "-" + name).toString('base64');
