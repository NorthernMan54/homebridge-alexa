    ...
    switch (cookie) {
      ...
      default:
        ...
        if (cookie.substring(0, 10) === "Station - ") {
          ...
          // console.log("mergeInputCookies", cookie, input);
          into[inputArray[i++]] = JSON.stringify(input);
        }
    }
...
const inputArray = ["AUX 1", "AUX 2", "AUX 3", "AUX 4", "AUX 5", "AUX 6", "AUX 7", "HDMI 1", "HDMI 2", "HDMI 3", "HDMI 4", "HDMI 5", "HDMI 6", "HDMI 7", "HDMI 8", "HDMI 9", "HDMI 10", "HDMI ARC", "INPUT 1", "INPUT 2", "INPUT 3", "INPUT 4", "INPUT 5", "INPUT 6", "INPUT 7", "INPUT 8", "INPUT 9", "INPUT 10", "LINE 1", "LINE 2", "LINE 3", "LINE 4", "LINE 5", "LINE 6", "LINE 7", "MEDIA PLAYER", "OPTICAL 1", "OPTICAL 2", "PHONO", "PLAYSTATION", "PLAYSTATION 3", "PLAYSTATION 4", "SATELLITE", "SMARTCAST", "TUNER", "TV", "USB DAC", "VIDEO 1", "VIDEO 2", "VIDEO 3", "XBOX", "BLURAY", "CABLE", "CD", "COAX 1", "COAX 2", "COMPOSITE 1", "DVD", "GAME", "HD RADIO", "IPOD"];
...
function lookupCapabilities(capability, options, operations, devices) {
  ...
  switch (capability) {
    ...
    case "Input Source":
      ...
      // console.log("Supported Inputs", capability, options, operations, devices, this);
...
function inputs(options, accessories) {
  ...
  // console.log("Inputs(", options, accessories);
