...
// statusObject, status.characteristics, message
function stateToProperties(statusObject, hbResponse) {
  ...
  statusObject.interface.split(",").forEach((element, i) => {
...
function _getHBValue(element, hbResponse, i) {
  debug("_getHBValue", element, hbResponse, i);
  var value, status;
