    ...
    */
    ...
    case "Target Door State": // TargetDoorState
      if (context.options.door) {
        ...
        reportState.push(messages.reportState("Alexa.ModeController", context));
        // reportState.push(messages.reportState("Alexa.RangeController", context));
  ...
  case "Mute": // Speaker volume
    ...
    */
    ...
    case "Target Heating Cooling State":
      // debug('Target Heating Cooling State', context, this);
      if (context.options.thermostatTurnOn) {
    ...
    case "Current Heating Cooling State":
      // Alexa doesn't report Furnace state.  Issue # 312
      // reportState.push(messages.reportState("Alexa.ThermostatControllerthermostatMode", context));
